 ...
 * @param props.numCandles - Number of candles to display (default: 9)
 * @param props.girlImage - Path to girl image
 * @param props.cakeImage - Path to cake image
 * @param props.candleImage - Path to candle image
 * @param props.backgroundColor - Background color (default: '#000000')
 */
