...
class kt {
  ...
  _renderTextToCanvas(e, t, r, n, i) {
    const { canvas: s, context: a } = i, l = pt(t), u = M.measureText(e || " ", t), h = u.lines, c = u.lineHeight, d = u.lineWidths, f = u.maxLineWidth, m = u.fontProperties, x = s.height;
...
class Ke {
  constructor(e, t) {
    this.state = V.for2d(), this.renderer = e, this._adaptor = t, this.renderer.runners.contextChange.add(this), this._managedGraphics = new B({ renderer: e, type: "renderable", priority: -1, name: "graphics" });
  }
  contextChange() {
...
class qe {
   ...
   */
  constructor(e, t) {
    this.state = V.for2d(), this.localUniforms = new G({
      uTranslationMatrix: { value: new P(), type: "mat3x3<f32>" },
      uColor: { value: new Float32Array(4), type: "vec4<f32>" },
      uRound: { value: 1, type: "f32" },
      uResolution: { value: [0, 0], type: "vec2<f32>" }
    }), this.renderer = e, this.adaptor = t, this.defaultShader = new $t(), this.state = V.for2d(), this._managedContainers = new B({ renderer: e, type: "renderable", name: "particleContainer" });
  }
  validateRenderable(e) {
    return !1;
  }
...
class rt {
  constructor(e) {
    this._state = V.default2d, this._renderer = e, this._managedTilingSprites = new B({ renderer: e, type: "renderable", name: "tilingSprite" });
  }
  validateRenderable(e) {
...
class nt {
  ...
  _updateContext(e, t) {
    ...
    const l = Tt(i, s, n, !0), u = s.padding, h = l.scale;
...
class at {
  ...
  async _buildTexturePromise(e) {
    const { text: t, style: r, resolution: n, textureStyle: i } = e, s = W.get(Xe), a = fr(t, r), l = await gr(a), u = Ot(t, r, l, s), h = Math.ceil(Math.ceil(Math.max(1, u.width) + r.padding * 2) * n), c = Math.ceil(Math.ceil(Math.max(1, u.height) + r.padding * 2) * n), d = s.image, f = 2;
    ...
    return i && (_.source.style = i), this._createCanvas && (this._renderer.texture.initSource(_.source), E.returnCanvasAndContext(g)), W.return(s), _;
  }
