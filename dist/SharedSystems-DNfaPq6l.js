import { F as Fe, v as Le, l as oe, M as g, x as He, y as We, S as ze, z as le, E as u, e as F, H as w, I as Ve, J as L, K as y, R as H, L as ue, N as Ne, t as m, b as f, i as G, w as W, O as Q, Q as je, c as Z, B as C, j as A, V as qe, u as S, k as T, W as P, X as $e, a as Ke, Y as de, Z as ce, _ as he, $ as fe, C as U, a0 as Ye, a1 as I, a2 as ee, D as z, a3 as Je, P as Xe, d as Qe, T as te, a4 as re, a5 as v, a6 as Ze, a7 as et } from "./index-C3oEeMNK.js";
import { B as pe, c as tt } from "./colorToUniform-CbCwKY4m.js";
...
class at extends Fe {
  constructor(e) {
    const { sprite: t, ...r } = e, s = new Le(t.texture), a = new oe({
...
const V = class me {
  constructor(e, t) {
    this.state = ze.for2d(), this._batchersByInstructionSet = /* @__PURE__ */ Object.create(null), this._activeBatches = /* @__PURE__ */ Object.create(null), this.renderer = e, this._adaptor = t, this._adaptor.init?.(this);
  }
  static getBatcher(e) {
...
function Me(n, e = !1) {
  ...
  for (const s in t) {
    ...
    for (let d = 0; d < l; d++) {
      const c = o[d];
      c.parentRenderGroup === n && c.relativeRenderGroupDepth === a && Se(c, r, 0);
    }
    O(o, l), i.index = 0;
  }
  if (e)
  ...
  _updateCachedRenderGroups(e, t) {
    ...
    if (e.invalidateMatrices(), e.isCachedAsTexture) {
      if (e.textureNeedsUpdate) {
        ...
        d._source.style = new Ye({ scaleMode: l }), e.texture = d, e._textureBounds || (e._textureBounds = new L()), e._textureBounds.copyFrom(r), s !== e.texture && e.renderGroupParent && (e.renderGroupParent.structureDidChange = !0);
      }
...
class Ge {
  ...
  generateTexture(e) {
    ...
    const i = e.frame?.copyTo(vt) || Je(s, xt).rectangle;
...
const X = class Oe {
  ...
  init(e) {
    e = {
      ...Oe.defaultOptions,
      ...e
    }, e.view && (v(Ze, "ViewSystem.view has been renamed to ViewSystem.canvas"), e.canvas = e.view), this.screen = new P(0, 0, e.width, e.height), this.canvas = e.canvas || z.get().createCanvas(), this.antialias = !!e.antialias, this.texture = be(this.canvas, e), this.renderTarget = new D({
